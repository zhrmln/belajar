...
if (isset($_GET['isi'])) {
	...
	<form method="post" action="simpan.php">
		...
		<div>
			...
			<input type="radio" name="revisi" value="Revisi Laporan"> Revisi <br>
			<input type="radio" name="revisi" value="Tidak Ada"> Tidak Ada
		</div>
	...
	<table border="1">
		...
		<tbody>
			...
			while($b = mysqli_fetch_array($kodelaporan)){
				...
				<td>
					<a href="edit.php?kode_laporan=<?php echo $b['kode_laporan'] ?>">EDIT</a> |
					<a href="hapus.php?kode_laporan=<?php echo $b['kode_laporan'] ?>">HAPUS</a>
				</td>
				</tr>
				<?php 
			}
